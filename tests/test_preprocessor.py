...
def test_normalize_text():
    assert normalize_text("BÜRO AG") == "büro ag"
    assert normalize_text("G.M.B.H") == "g.m.b.h"
    assert normalize_text("Büro-Offices & Co.") == "büro-offices & co."
    assert normalize_text("  Büro   AG  ") == "büro ag"
...
def test_legal_terms():
    ...
    assert standardize_legal_terms("Büro Offices GmbH & Co. KG") == "Büro Offices gmbh & Co. kg"
